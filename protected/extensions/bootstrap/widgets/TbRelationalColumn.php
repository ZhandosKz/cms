...
class TbRelationalColumn extends TbDataColumn
{
	...
	{
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-relational.css');
		...
		$loadingPic = CHtml::image($this->getController()->module->bootstrap->getAssetsUrl().'/img/loading.gif');
