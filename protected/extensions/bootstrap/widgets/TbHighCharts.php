...
class TbHighCharts extends CWidget
{
	...
	{
		$this->getController()->module->bootstrap->registerAssetJs('highcharts/highcharts.js');
		...
		if (isset($this->options['exporting']) && @$this->options['exporting']['enabled'])
			$this->getController()->module->bootstrap->registerAssetJs('highcharts/modules/exporting.js');
		if (isset($this->options['theme']))
			$this->getController()->module->bootstrap->registerAssetJs('highcharts/themes/' . $this->options['theme'] . '.js');
