...
class TbExtendedTooltip extends CWidget
{
	...
	protected function registerClientScript()
	{
		...
		else
		{
			...
			$this->getController()->module->bootstrap->registerAssetCss('bootstrap-editable-tooltip.css');
			$this->getController()->module->bootstrap->registerAssetJs('bootstrap-editable-tooltip.js');
