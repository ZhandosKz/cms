...
class TbToggleButton extends CInputWidget
{
	...
	protected function registerClientScript($id)
	{
		...
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-toggle-buttons.css');
		$this->getController()->module->bootstrap->registerAssetJs('jquery.toggle.buttons.js');
