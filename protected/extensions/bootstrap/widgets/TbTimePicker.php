...
class TbTimePicker extends CInputWidget
{
	...
	{
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-timepicker.css');
		$this->getController()->module->bootstrap->registerAssetJs('bootstrap.timepicker.js');
