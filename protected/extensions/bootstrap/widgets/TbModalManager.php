...
class TbModalManager extends CWidget
{
	...
	{
		$this->getController()->module->bootstrap->registerAssetJs('bootstrap-modalmanager.js', CClientScript::POS_HEAD);
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-modalmanager.css');
