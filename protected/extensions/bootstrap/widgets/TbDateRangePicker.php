...
class TbDateRangePicker extends CInputWidget
{
	...
	{
		if ($this->selector)
			$this->getController()->module->bootstrap->registerDateRangePlugin($this->selector, $this->options, $this->callback);
		else
		{
            ...
            $this->getController()->module->bootstrap->registerDateRangePlugin('#' . $id, $this->options, $this->callback);
		}
	...
	{
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-daterangepicker.css');
		$this->getController()->module->bootstrap->registerAssetJs('bootstrap.daterangepicker.js');
		$this->getController()->module->bootstrap->registerAssetJs('date.js');
	}
}
