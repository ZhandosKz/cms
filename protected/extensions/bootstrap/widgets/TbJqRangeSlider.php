...
class TbJqRangeSlider extends CInputWidget
{
	...
	public function registerClientScript($id)
	{
		...
		$this->getController()->module->bootstrap->registerAssetJs('jquery.mousewheel.min.js');
		$this->getController()->module->bootstrap->registerAssetCss('jqslider/'.$this->theme.'.css');
		$this->getController()->module->bootstrap->registerAssetJs('jqslider/JQAllRangeSliders'.(YII_DEBUG?'':'-min').'.js');
