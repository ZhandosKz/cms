...
class TbHtml5Editor extends CInputWidget
{
	...
	{
		$this->getController()->module->bootstrap->registerAssetCss('bootstrap-wysihtml5.css');
		$this->getController()->module->bootstrap->registerAssetJs('wysihtml5-0.3.0.js');
		$this->getController()->module->bootstrap->registerAssetJs('bootstrap-wysihtml5.js');

		if (isset($this->editorOptions['locale']))
		{
			$this->getController()->module->bootstrap->registerAssetJs('locales/bootstrap-wysihtml5.'.$this->editorOptions['locale'].'.js');
		}
		elseif (in_array($this->lang, array('de-DE','es-ES','fr','fr-NL','pt-BR','sv-SE')))
		{
			$this->getController()->module->bootstrap->registerAssetJs('locales/bootstrap-wysihtml5.'.$this->lang.'.js');
	...
	private function insertDefaultStylesheetIfColorsEnabled()
	{
		...
		$defaultStyleSheetUrl = $this->getController()->module->bootstrap->getAssetsUrl() . '/css/wysiwyg-color.css';
