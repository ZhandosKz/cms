...
class TbColorPicker extends CInputWidget
{
	...
	{
        $this->getController()->module->bootstrap->registerAssetJs('bootstrap.colorpicker.js', CClientScript::POS_HEAD);
        $this->getController()->module->bootstrap->registerAssetCss('bootstrap-colorpicker.css');
